                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="h-12 rounded-lg border-gray-200 pl-10 focus:border-amber-500 focus:ring-amber-500"
                        />
                    </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="h-12 rounded-lg border-gray-200 pr-10 pl-10 focus:border-amber-500 focus:ring-amber-500"
                        />
                        <button
                            type="button"
